...
This file is a cleaned but intentionally detailed context record derived from the master Markdown source. Exact order IDs, phone numbers, emails, passport fields, QR-related fields, and private service links are masked where present. Duplicates are not aggressively removed when they preserve different contexts, statuses, or decisions.
